 ...
 *
 * Пустой слот — прочерк. Совсем пустой текст схлопывает объект по высоте, и
 * список начинает прыгать при каждой смене состава; пробел эту беду решал, но
 * пустая строка на экране неотличима от неотрисованной, а прочерк ясно говорит
 * «здесь ничего нет».
 */
